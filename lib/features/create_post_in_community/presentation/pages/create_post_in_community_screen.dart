    ...
    showDialog(
      ...
      builder: (context) {
        return AlertDialog(
          ...
          content:
              Text(context.tr(AppStrings.areYouSureYouWantToDeleteThisPoll)),
          actions: [
            TextButton(
              onPressed: () {
      ...
      builder: (context, themeState) {
        ...
        return Scaffold(
          appBar: AppBar(
            title: Text(
              widget.feed == null
                  ? context.tr(AppStrings.createPost)
                  ...
                  return Stack(
                    children: [
                                      ...
                                      return TextFormField(
                                        ...
                                        onChanged: (value) {
                                          if (cubit.editableFeed == null) {
                                            ...
                                            cubit
                                                .editFeedContentForEditableFeed(
                                                    value);
                                          }
                                    ...
                                    child: Card(
                                      ...
                                      child: Stack(
                                        children: [
                                          ...
                                          Positioned(
                                            top: 8,
                                            right: LocalizationService
                                                    .instance.isRTL
                                                ? null
                                                : 8,
                                            left: LocalizationService
                                                    .instance.isRTL
                                                ? 8
                                                : null,
                                            child: IconButton(
                                    ...
                                    if (cubit.editableFeed != null &&
                                      ...
                                      Padding(
                                        ...
                                        child: GridView.builder(
                                          ...
                                          itemCount: cubit
                                              .editableFeed!.mediaPath!.length,
                                          itemBuilder: (context, index) {
                                            final imageUrl = cubit.editableFeed!
                                                .mediaPath![index];
                                            return Stack(
                                              alignment: Alignment.topRight,
                                              children: [
                      ...
                      Container(
                        ...
                        margin:
                            EdgeInsets.only(bottom: isKeyboardVisible ? 0 : 0),
                              ...
                              loaded: (
                                ...
                                if (widget.feed != null &&
                                  ...
                                  return Center(
                                    child: Text(
                                      context.tr(
                                          AppStrings.yourPollHasBeenPublished),
                                      style: TextStyle(
                                          color: Colors.grey.shade600),
                                    ),
                                  );
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        if (!hasPoll) ...[
                                          ElevatedButton.icon(
                                            onPressed: () =>
                                                cubit.pickImageAndShowIt(
                                                    false, context),
                                            icon:
                                                const Icon(Icons.photo_library),
                                            label: Text(
                                              context.tr(AppStrings.gallery),
                                              style: TextStyle(
                                                  color: isDarkMode
                                                      ? AppColors.darkTitle
                                                      : AppColors.primary),
