...
Future<void> showDeleteFeedPostDialog({
...
class _DeleteFeedPostDialog extends StatelessWidget {
  final bool isDark;
  final VoidCallback onConfirm;

  const _DeleteFeedPostDialog({
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      context.tr(AppStrings.deletePostQuestion),
