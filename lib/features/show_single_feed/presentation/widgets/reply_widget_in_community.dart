            ...
            return AnimatedContainer(
              ...
              decoration: BoxDecoration(
                color: replyModel.id.toString() == highlightedCommentId
                    ...
                    : Colors.transparent, // Ensure a clear start and end color
                borderRadius:
                    BorderRadius.circular(8), // Add subtle rounding for effect
              ),
                                ...
                                child: replyModel.doctor == null
                                    ...
                                    : replyModel.doctor!.id == null
                                        ...
                                        : CustomCachedNetworkImage(
                                            imageUrl: replyModel.doctor!.image
                                                .toString(),
                                            height: 100.h,
                                            width: 100.w,
                                          ),
                        ...
                        children: [
                          ...
                          Text(
                            ...
                            textDirection: RegExp(r'[\u0600-\u06FF]')
                                    .hasMatch(replyModel.comment.toString())
