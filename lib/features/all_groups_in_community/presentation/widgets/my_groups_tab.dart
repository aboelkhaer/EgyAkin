...
class _MyGroupsTabState extends State<MyGroupsTab> {
  ...
  Widget build(BuildContext context) {
    final cubit = MyGroupsInCommunityCubit.get(context);
    return BlocBuilder<ThemeBloc, ThemeState>(
      builder: (context, themeState) {
        ...
        return RefreshIndicator(
          color: primary,
          onRefresh: () => cubit.getMyGroups(),
          child:
              BlocBuilder<MyGroupsInCommunityCubit, MyGroupsInCommunityState>(
                    ...
                    return ListView(
                      ...
                      children: [
                        ...
                        DashboardEmptyState(
                          ...
                          title: context.tr(AppStrings.noGroupsYet),
                          subtitle: context.tr(
                            AppStrings.createOrJoinGroupToCollaborate,
                          ),
                          hint: context.tr(AppStrings.tapPlusToCreateGroup),
