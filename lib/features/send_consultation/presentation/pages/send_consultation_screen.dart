...
class _SendConsultationScreenState extends State<SendConsultationScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      floatingActionButton: widget.ownerOfConsultationId !=
              widget.currentDoctorModel.id.toString()
          ? const SizedBox.shrink()
          : Column(
                                                ...
                                                child: Container(
                                                  ...
                                                  child: Row(
                                                    children: [
                                                      ...
                                                      SizedBox(width: 12.w),
                                                      // Doctor name and owner indicator
                                                      Expanded(
                                                        child: Row(
                                                          children: [
                                                            Expanded(
                                                              child: Text(
                                                                'Dr.${capitalizeFirstText(doctorModel.firstName.toString())}${doctorModel.lastName != null ? ' ${capitalizeFirstText(doctorModel.lastName.toString()) ?? ''}' : ''}',
                                                                style:
                                                                    TextStyle(
                                                                  fontSize:
                                                                      14.sp,
