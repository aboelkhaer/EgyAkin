...
class _ApiServices implements ApiServices {
  ...
  Future<GetFiltersOptionsModelResponse> getFiltersOptions() async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<GetFiltersOptionsModelResponse>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late GetFiltersOptionsModelResponse _value;
    try {
      _value = GetFiltersOptionsModelResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
