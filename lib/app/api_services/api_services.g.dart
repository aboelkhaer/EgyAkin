  ...
  Future<SignOutModelResponse> signOut() async {
    ...
    final _options = _setStreamType<SignOutModelResponse>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          'https://test.egyakin.com/api/v2/logout',
  ...
  Future<AuthenticationModelResponse> signIn(
    ...
    final _options = _setStreamType<AuthenticationModelResponse>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          'https://test.egyakin.com/api/v2/login',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
  ...
  Future<AuthenticationModelResponse> register(
    ...
    final _options = _setStreamType<AuthenticationModelResponse>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          'https://test.egyakin.com/api/v2/register',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
  ...
  Future<GetAllDoctorsPatientsModelResponse> getAllPatients(
    ...
    final _options = _setStreamType<GetAllDoctorsPatientsModelResponse>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          'https://test.egyakin.com/api/v2/allPatientsNew',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
  ...
  Future<GetProfilePatientsModelResponse> getProfilePatients(
    ...
    final _options = _setStreamType<GetProfilePatientsModelResponse>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          'https://test.egyakin.com/api/v2/doctorProfileGetPatients/${doctorId}',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
  ...
  Future<GetDoctorPatientsModelResponse> getCurrentPatients(
    ...
    final _options = _setStreamType<GetDoctorPatientsModelResponse>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          'https://test.egyakin.com/api/v2/currentPatientsNew',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
  ...
  Future<GetSearchModelResponse> searchHome(
    ...
    final _options = _setStreamType<GetSearchModelResponse>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          'https://test.egyakin.com/api/v2/searchNew',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
  ...
  Future<UpdateDoctorProfileModelResponse> updateProfile(
    ...
    final _options = _setStreamType<UpdateDoctorProfileModelResponse>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          'https://test.egyakin.com/api/v2/users',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
  ...
  Future<GetPatientSectionsModelResponse> getPatientSections(
    ...
    final _options = _setStreamType<GetPatientSectionsModelResponse>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          'https://test.egyakin.com/api/v2/showSections/${patientId}',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
  ...
  Future<GetPatientSectionDetailsModelResponse> getSectionDetails(
    ...
    final _options =
      ...
      extra: _extra,
            ...
            .compose(
              _dio.options,
              'https://test.egyakin.com/api/v2/patient/${sectionId}/${patientId}',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(
  ...
  Future<DeletePatientModelResponse> deletePatient(String patientId) async {
    ...
    final _options = _setStreamType<DeletePatientModelResponse>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          'https://test.egyakin.com/api/v2/patient/${patientId}',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
  ...
  Future<UpdatePatientSectionDetailsModelResponse> updateSectionDetails(
    ...
    final _options =
      ...
      extra: _extra,
            ...
            .compose(
              _dio.options,
              'https://test.egyakin.com/api/v2/patientsection/${sectionId}/${patientId}',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(
  ...
  Future<GetPatientHistoryForAddPatientModelResponse>
    ...
    final _options =
      ...
      extra: _extra,
            ...
            .compose(
              _dio.options,
              'https://test.egyakin.com/api/v2/questions/${sectionId}',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(
  ...
  Future<AddPatientForFirstTimeModelResponse> addPatientForFirstTime(
    ...
    final _options =
      ...
      extra: _extra,
            ...
            .compose(
              _dio.options,
              'https://test.egyakin.com/api/v2/patient',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(
  ...
  Future<FinalSubmitModelResponse> finalSubmit(String patientId) async {
    ...
    final _options = _setStreamType<FinalSubmitModelResponse>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          'https://test.egyakin.com/api/v2/submitStatus/${patientId}',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
  ...
  Future<GetPatientCommentsModelResponse> getPatientComments(
    ...
    final _options = _setStreamType<GetPatientCommentsModelResponse>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          'https://test.egyakin.com/api/v2/comment/${patientId}',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
  ...
  Future<AddPatientCommentsModelResponse> addComment(
    ...
    final _options = _setStreamType<AddPatientCommentsModelResponse>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          'https://test.egyakin.com/api/v2/comment',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
  ...
  Future<DeletePatientCommentsModelResponse> deleteComment(
    ...
    final _options = _setStreamType<DeletePatientCommentsModelResponse>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          'https://test.egyakin.com/api/v2/comment/${commentId}',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
  ...
  Future<ContactUsModelResponseModelResponse> addContactUs(
    ...
    final _options =
      ...
      extra: _extra,
            ...
            .compose(
              _dio.options,
              'https://test.egyakin.com/api/v2/contact',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(
  ...
  Future<PostCommentsModelResponse> getPostComments(String postId) async {
    ...
    final _options = _setStreamType<PostCommentsModelResponse>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          'https://test.egyakin.com/api/v2/Postcomments/${postId}',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
  ...
  Future<DeletePostCommentModelResponse> deletePostComment(
    ...
    final _options = _setStreamType<DeletePostCommentModelResponse>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          'https://test.egyakin.com/api/v2/Postcomments/${commentId}',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
  ...
  Future<GetAllNotificationsModelResponse> getAllNotifications(
    ...
    final _options = _setStreamType<GetAllNotificationsModelResponse>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          'https://test.egyakin.com/api/v2/shownotification',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
  ...
  Future<UpdateNotificationModelResponse> updateNotifications() async {
    ...
    final _options = _setStreamType<UpdateNotificationModelResponse>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          'https://test.egyakin.com/api/v2/notification',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
  ...
  Future<AddCommentOnPostModelResponse> addCommentOnPost(
    ...
    final _options = _setStreamType<AddCommentOnPostModelResponse>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          'https://test.egyakin.com/api/v2/Postcomments',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
  ...
  Future<ResetPasswordModelResponse> sendEmailForForgetPassword(
    ...
    final _options = _setStreamType<ResetPasswordModelResponse>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          'https://test.egyakin.com/api/v2/forgotpassword',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
  ...
  Future<ResetPasswordModelResponse> verifyOTP(
    ...
    final _options = _setStreamType<ResetPasswordModelResponse>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          'https://test.egyakin.com/api/v2/resetpasswordverification',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
  ...
  Future<ResetPasswordModelResponse> changePassword(
    ...
    final _options = _setStreamType<ResetPasswordModelResponse>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          'https://test.egyakin.com/api/v2/resetpassword',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
  ...
  Future<SendEmailForVerificationModelResponse> sendEmailVerification() async {
    ...
    final _options =
      ...
      extra: _extra,
            ...
            .compose(
              _dio.options,
              'https://test.egyakin.com/api/v2/sendverificationmail',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(
  ...
  Future<SendOTPForEmailVerificationModelResponse> sendOTPForEmailVerification(
    ...
    final _options =
      ...
      extra: _extra,
            ...
            .compose(
              _dio.options,
              'https://test.egyakin.com/api/v2/emailverification',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(
  ...
  Future<HomeModelResponse> getHome() async {
    ...
    final _options = _setStreamType<HomeModelResponse>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          'https://test.egyakin.com/api/v2/homeNew',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
  ...
  Future<UploadProfileImageModelResponse> uploadProfileImage(File image) async {
    ...
    final _options = _setStreamType<UploadProfileImageModelResponse>(Options(
      ...
      contentType: 'multipart/form-data',
        ...
        .compose(
          _dio.options,
          'https://test.egyakin.com/api/v2/upload-profile-image',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
  ...
  Future<DoctorInfoViewModelResponse> getDoctorInfoView(String doctorId) async {
    ...
    final _options = _setStreamType<DoctorInfoViewModelResponse>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          'https://test.egyakin.com/api/v2/showAnotherProfile/${doctorId}',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
  ...
  Future<DownloadPatientReportModelResponse> downloadPatientReport(
    ...
    final _options = _setStreamType<DownloadPatientReportModelResponse>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          'https://test.egyakin.com/api/v2/generatePDF/${patientId}',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
  ...
  Future<GetAppSettingsModelResponse> getAppSettings() async {
    ...
    final _options = _setStreamType<GetAppSettingsModelResponse>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          'https://test.egyakin.com/api/v2/settings',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
  ...
  Future<UploadSyndicateCardModelResponse> uploadSyndicateCard(
    ...
    final _options = _setStreamType<UploadSyndicateCardModelResponse>(Options(
      ...
      contentType: 'multipart/form-data',
        ...
        .compose(
          _dio.options,
          'https://test.egyakin.com/api/v2/uploadSyndicateCard',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
  ...
  Future<ChangePasswordModelResponse> changePasswordFeature(
    ...
    final _options = _setStreamType<ChangePasswordModelResponse>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          'https://test.egyakin.com/api/v2/changePassword',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
  ...
  Future<SendFCMTokenModelResponse> sendFCMToken(String? fcmToken) async {
    ...
    final _options = _setStreamType<SendFCMTokenModelResponse>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          'https://test.egyakin.com/api/v2/storeFCM',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
  ...
  Future<GetDoctorProfileScoreModelResponse> getDoctorProfileScoreHistory(
    ...
    final _options = _setStreamType<GetDoctorProfileScoreModelResponse>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          'https://test.egyakin.com/api/v2/doctorProfileGetScoreHistory/${doctorId}',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
  ...
  Future<GetConsultationSearchModelResponse> consultationDoctorSearch(
    ...
    final _options = _setStreamType<GetConsultationSearchModelResponse>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          'https://test.egyakin.com/api/v2/consultationDoctorSearch/${searchContent}',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
  ...
  Future<SendConsultationModelResponse> sendConsultation(
    ...
    final _options = _setStreamType<SendConsultationModelResponse>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          'https://test.egyakin.com/api/v2/consultations',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
  ...
  Future<List<GetCurrentDoctorConsultationModelResponse>>
    ...
    final _options =
      ...
      extra: _extra,
            ...
            .compose(
              _dio.options,
              'https://test.egyakin.com/api/v2/consultations/sent',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(
  ...
  Future<List<GetCurrentDoctorConsultationModelResponse>>
    ...
    final _options =
      ...
      extra: _extra,
            ...
            .compose(
              _dio.options,
              'https://test.egyakin.com/api/v2/consultations/received',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(
  ...
  Future<GetConsultationDetailsModelResponse> getConsultationDetails(
    ...
    final _options =
      ...
      extra: _extra,
            ...
            .compose(
              _dio.options,
              'https://test.egyakin.com/api/v2/consultations/${consultationId}',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(
  ...
  Future<List<GetAchievementsModelResponse>> getAchievements(
    ...
    final _options = _setStreamType<List<GetAchievementsModelResponse>>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          'https://test.egyakin.com/api/v2/users/${doctorId}/achievements',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
  ...
  Future<SyndicateCardVerifyModelResponse> changeSyndicateCardStatus(
    ...
    final _options = _setStreamType<SyndicateCardVerifyModelResponse>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          'https://test.egyakin.com/api/v2/users/${doctorId}',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
  ...
  Future<ApplyPatientFiltersModelResponse> applyPatientFilters(
    ...
    final _options = _setStreamType<ApplyPatientFiltersModelResponse>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          'https://test.egyakin.com/api/v2/patientFilters',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
  ...
  Future<GetPostsCommunityModelResponse> getAllFeeds(int pageNumber) async {
    ...
    final _options = _setStreamType<GetPostsCommunityModelResponse>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          'https://test.egyakin.com/api/v2/feed/posts',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
  ...
  Future<AddLikeOnPostModelResponse> addLikeOrUnlikeOnPost(
    ...
    final _options = _setStreamType<AddLikeOnPostModelResponse>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          'https://test.egyakin.com/api/v2/feed/posts/${postId}/likeOrUnlikePost',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
  ...
  Future<SaveOrUnsavePostModelResponse> saveOrUnsavePost(
    ...
    final _options = _setStreamType<SaveOrUnsavePostModelResponse>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          'https://test.egyakin.com/api/v2/feed/posts/${postId}/saveOrUnsavePost',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
  ...
  Future<GetAiConsultationHistoryModelResponse> getAIConsultationHistory(
    ...
    final _options =
      ...
      extra: _extra,
            ...
            .compose(
              _dio.options,
              'https://test.egyakin.com/api/v2/AIconsultation-history/${patientId}',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(
  ...
  Future<SendAIConsultationRequestModelResponse> sendAIConsultationRequest(
    ...
    final _options =
      ...
      extra: _extra,
            ...
            .compose(
              _dio.options,
              'https://test.egyakin.com/api/v2/AIconsultation/${patientId}',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(
  ...
  Future<DeletePostModelResponse> deletePostInFeeds(String postId) async {
    ...
    final _options = _setStreamType<DeletePostModelResponse>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          'https://test.egyakin.com/api/v2/feed/posts/${postId}',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
  ...
  Future<GetCommentsInCommunityModelResponse> getCommentsInCommunity(
    ...
    final _options =
      ...
      extra: _extra,
            ...
            .compose(
              _dio.options,
              'https://test.egyakin.com/api/v2/posts/${postId}/comments',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(
  ...
  Future<AddLikeOrUnlikeOnCommentInCommunityModelResponse>
    ...
    final _options =
      ...
      extra: _extra,
                ...
                .compose(
                  _dio.options,
                  'https://test.egyakin.com/api/v2/comments/${commentId}/likeOrUnlikeComment',
                  queryParameters: queryParameters,
                  data: _data,
                )
                .copyWith(
  ...
  Future<CreateCommentOnPostInCommunityModelResponse>
    ...
    final _options =
      ...
      extra: _extra,
            ...
            .compose(
              _dio.options,
              'https://test.egyakin.com/api/v2/feed/posts/${postId}/comment',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(
  ...
  Future<DeleteCommentOnPostInCommunityModelResponse>
    ...
    final _options =
      ...
      extra: _extra,
            ...
            .compose(
              _dio.options,
              'https://test.egyakin.com/api/v2/feed/comments/${commentId}',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(
  ...
  Future<GetGroupDetailsInCommunityModelResponse> getGroupDetailsInCommunity(
    ...
    final _options =
      ...
      extra: _extra,
            ...
            .compose(
              _dio.options,
              'https://test.egyakin.com/api/v2/groups/${groupId}/detailsWithPosts',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(
  ...
  Future<GetGroupsTabModelResponse> getGroupsTab(int pageNumber) async {
    ...
    final _options = _setStreamType<GetGroupsTabModelResponse>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          'https://test.egyakin.com/api/v2/latest-groups-with-random-posts',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
  ...
  Future<JoinGroupModelResponse> joinGroupInCommunity(String groupId) async {
    ...
    final _options = _setStreamType<JoinGroupModelResponse>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          'https://test.egyakin.com/api/v2/groups/${groupId}/join',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
  ...
  Future<LeaveGroupModelResponse> leaveGroupInCommunity(String groupId) async {
    ...
    final _options = _setStreamType<LeaveGroupModelResponse>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          'https://test.egyakin.com/api/v2/groups/${groupId}/leave',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
  ...
  Future<GetGroupMembersModelResponse> getGroupMembers(
    ...
    final _options = _setStreamType<GetGroupMembersModelResponse>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          'https://test.egyakin.com/api/v2/groups/${groupId}/members',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
  ...
  Future<GetPostLikesModelResponse> getPostLikes(
    ...
    final _options = _setStreamType<GetPostLikesModelResponse>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          'https://test.egyakin.com/api/v2/posts/${postId}/likes',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
  ...
  Future<GetAllGroupsInCommunityModelResponse> getMyGroup(
    ...
    final _options =
      ...
      extra: _extra,
            ...
            .compose(
              _dio.options,
              'https://test.egyakin.com/api/v2/mygroups',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(
  ...
  Future<SendInvitationModelResponse> sendGroupInvitation(
    ...
    final _options = _setStreamType<SendInvitationModelResponse>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          'https://test.egyakin.com/api/v2/groups/${groupId}/invite',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
  ...
  Future<RemoveMemberFromGroupModelResponse> removeMemberFromGroup(
    ...
    final _options = _setStreamType<RemoveMemberFromGroupModelResponse>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          'https://test.egyakin.com/api/v2/groups/${groupId}/removeMember',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
  ...
  Future<GetAllGroupsInCommunityModelResponse> getAllGroups(
    ...
    final _options =
      ...
      extra: _extra,
            ...
            .compose(
              _dio.options,
              'https://test.egyakin.com/api/v2/groups',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(
  ...
  Future<DeleteGroupInCommunityModelResponse> deleteGroupInCommunity(
    ...
    final _options =
      ...
      extra: _extra,
            ...
            .compose(
              _dio.options,
              'https://test.egyakin.com/api/v2/groups/${groupId}',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(
  ...
  Future<GetTrendingTabInCommunityModelResponse> getTrendingPostsInCommunity(
    ...
    final _options =
      ...
      extra: _extra,
            ...
            .compose(
              _dio.options,
              'https://test.egyakin.com/api/v2/feed/trendingPosts',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(
  ...
  Future<GetResponseOfSearchModel> getCommunitySearchResponse(
    ...
    final _options = _setStreamType<GetResponseOfSearchModel>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          'https://test.egyakin.com/api/v2/feed/searchPosts',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
  ...
  Future<GetAllDoctorPostsModelResponse> getAllDoctorPosts(
    ...
    final _options = _setStreamType<GetAllDoctorPostsModelResponse>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          'https://test.egyakin.com/api/v2/doctorposts/${doctorId}',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
  ...
  Future<GetSavedPostsModelResponse> getSavedPosts(
    ...
    final _options = _setStreamType<GetSavedPostsModelResponse>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          'https://test.egyakin.com/api/v2/doctorsavedposts/${doctorId}',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
  ...
  Future<AddVoteAndUnvoteModelResponse> addVoteForPollInPosts(
    ...
    final _options = _setStreamType<AddVoteAndUnvoteModelResponse>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          'https://test.egyakin.com/api/v2/polls/${pollId}/vote',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
  ...
  Future<AddOptionInPollModelResponse> addOptionOnPoll(
    ...
    final _options = _setStreamType<AddOptionInPollModelResponse>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          'https://test.egyakin.com/api/v2/polls/${pollId}/options',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
  ...
  Future<GetPollVotersModelResponse> getPollVoters(
    ...
    final _options = _setStreamType<GetPollVotersModelResponse>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          'https://test.egyakin.com/api/v2/polls/${pollId}/options/${optionId}/voters',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
  ...
  Future<GetDoctorInvitationForGroupsModelResponse>
    ...
    final _options =
      ...
      extra: _extra,
            ...
            .compose(
              _dio.options,
              'https://test.egyakin.com/api/v2/groups/invitations/${doctorId}',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(
  ...
  Future<AcceptOrDeclineMemberModelResponse> acceptOrDeclineMemberInGroup(
    ...
    final _options = _setStreamType<AcceptOrDeclineMemberModelResponse>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          'https://test.egyakin.com/api/v2/groups/${groupId}/invitation',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
  ...
  Future<GetRecommendationsModelResponse> getRecommendations(
    ...
    final _options = _setStreamType<GetRecommendationsModelResponse>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          'https://test.egyakin.com/api/v2/recommendations/${patientId}',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
  ...
  Future<SearchForDoseInMedicationSectionModelResponse>
    ...
    final _options =
      ...
      extra: _extra,
            ...
            .compose(
              _dio.options,
              'https://test.egyakin.com/api/v2/dose/search/${dose}',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(
  ...
  Future<CreateNewMedicineModelResponse> createNewMedicine(
    ...
    final _options = _setStreamType<CreateNewMedicineModelResponse>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          'https://test.egyakin.com/api/v2/dose',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
  ...
  Future<GetMembersForConsultationModelResponse> getMembersForConsultation(
    ...
    final _options =
      ...
      extra: _extra,
            ...
            .compose(
              _dio.options,
              'https://test.egyakin.com/api/v2/consultations/${consultationId}/members',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(
  ...
  Future<LockOrUnlockConsultationModelResponse> lockOrUnlockConsultation(
    ...
    final _options =
      ...
      extra: _extra,
            ...
            .compose(
              _dio.options,
              'https://test.egyakin.com/api/v2/consultations/${consultationId}/toggle-status',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(
  ...
  Future<RemoveMemberFromConsultationModelResponse>
    ...
    final _options =
      ...
      extra: _extra,
            ...
            .compose(
              _dio.options,
              'https://test.egyakin.com/api/v2/consultations/${consultationId}/doctors/${doctorId}',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(
  ...
  Future<AddDoctorsForConsultationModelResponse> addDoctorsForConsultation(
    ...
    final _options =
      ...
      extra: _extra,
            ...
            .compose(
              _dio.options,
              'https://test.egyakin.com/api/v2/consultations/${consultationId}/add-doctors',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(
  ...
  Future<ChangeLanguageModelResponse> changeLanguage(String locale) async {
    ...
    final _options = _setStreamType<ChangeLanguageModelResponse>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          'https://test.egyakin.com/api/v2/user/locale',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
  ...
  Future<ExportPatientsModelResponse> exportFilteredPatients() async {
    ...
    final _options = _setStreamType<ExportPatientsModelResponse>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          'https://test.egyakin.com/api/v2/exportFilteredPatients',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
